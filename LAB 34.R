...
genes<-as.matrix(
  read.csv("C:\\Users\\Usuario\\OneDrive\\Escritorio\\DOCTORADO\\DRA. CARLA-COMPLEJIDAD ECONÓMICA\\LABS\\LAB 34\\heatmap_data.csv",
           sep=",",
  header=T,
  row.names=1))


annotation_col<-read.csv("C:\\Users\\Usuario\\OneDrive\\Escritorio\\DOCTORADO\\DRA. CARLA-COMPLEJIDAD ECONÓMICA\\LABS\\LAB 34\\annotation_col.csv",
           header=T,
           row.names=1)

annotation_row<-read.csv("C:\\Users\\Usuario\\OneDrive\\Escritorio\\DOCTORADO\\DRA. CARLA-COMPLEJIDAD ECONÓMICA\\LABS\\LAB 34\\annotation_row.csv",
                                                  row.names=1)
...
pheatmap(sub,frontsize=6, cluster_rows=T,cluster_cols = T,annotation_row=annotation_row,annotation_col = annotation_col,treeheight_row = 0,treeheight_col = 0,main = "expresión genética",fontsize = 8,allocation_legend=F,display_numbers = T,fontsize_number = 6)
...
pheatmap(sub,frontsize=6, cluster_rows=T,cluster_cols = T,annotation_row=annotation_row,annotation_col = annotation_col,treeheight_row = 0,treeheight_col = 0,main = "expresión genética",fontsize = 8,allocation_legend=F,display_numbers = T,fontsize_number = 6,col=viridis_pal(option="magma")(6))
